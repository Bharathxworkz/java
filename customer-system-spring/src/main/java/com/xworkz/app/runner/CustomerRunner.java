...
public class CustomerRunner {
    ...
    public static void main(String[] args) {
        ...
        customerDto.setCustomerName("prema");
        customerDto.setEmail("prema@gmail.com");
...
//        System.out.println("Deleted the row...!!");
        ...
        Object [] obj = customerService.getNoAndNameByEmail("franklinh@example.com");
        Arrays.stream(obj).forEach(System.out::println);

        boolean updated = customerService.updateNoByName(987654321,"Franklin Harris");
