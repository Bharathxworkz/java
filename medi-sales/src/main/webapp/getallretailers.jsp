...
<body>
    ...
    <h2>STOCK DETAILS</h2>
                    <table>
                        <tr>
                            <th>Sl No </th><th>Retailer Name</th><th>Contact Number</th><th>Email</th><th>GstInNumber</th>
                            <th>Address</th>
                        </tr>
                        <ref:forEach items="${listOfretailers}" var="dto" varStatus="status">
                            <tr>
                                <td>${status.index + 1}</td>
                                <td>${dto.getRetailerName()}</td>
