...
<head>
  ...
  <title>Retailer Registration - Marg ERP Cloud</title>
...
<body>
  ...
  <div class="container">
    <div class="form-section">
      ...
      <form action="${pageContext.request.contextPath}/addingretailer" method="post" onsubmit="return validateForm()">
        <!-- Vendor Name -->
        <div class="error-message" style="color: red;">${vendorNameError}</div>
        <i class="fas fa-user"></i>
        <div id="vendorNameError" class="error-message"></div>
        <div class="form-group">
          <input type="text" id="retailerName" name="retailerName" value="${dto.retailerName}" placeholder="Retailer Name" required>
        </div>
  ...
  <script>
    ...
    document.getElementById("retailerName").addEventListener("blur", validateRetailerName);
